      ...
      <div v-if="isSidebarExpanded" class="nav-links">
        ...
        <div class="menu-group">
          ...
          <div v-if="activeTab === 'analysis'" class="sub-links">
            <router-link to="/mainpage/DataAnalysis/EDA" class="button sub-item">Exploratory Data</router-link>
            <router-link to="/mainpage/DataAnalysis/Clean" class="button sub-item">Data Cleaning</router-link>
